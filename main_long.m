function [xhat, p_vec] = main_long(search_path_input, pID)
...
meal_times = find(meal_mgpmin(:,1));

%Creates empty array for new hypothesized meal times
meal_hypos = zeros(length(meal_mgpmin(:,1)),1);
...
for i=-2:2
    ...
    meal_hypos(h_meal_times,i+3) = meal_mgpmin(meal_times,1); 
end
